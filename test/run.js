  ...
  describe('#doTheJob', function () {
    ...
    it('docObject qui renvoie canvasOK @1', function (done) {
      business.doTheJob( docObject, function (err) {
		  ...
		  expect(docObject.auteur.value).to.be.equal('Ricardo R. Silva Fabien Jourdan Diego M. Salvanha Fabien Letisse Emilien Jamin Simone Guidetti-Gonzalez Carlos A. Labate Ricardo Z. N. Vencio');
